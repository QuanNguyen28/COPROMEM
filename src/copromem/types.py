...
class CostLedger:
    ...
    def runtime_cost(self) -> float:
        return self.planner_calls + self.solver_calls + self.reviewer_calls + self.verifier_cost
...
class WorkflowRun:
    ...
    def success(self) -> bool:
        return self.solution.output_rows == self.task.expected_rows and self.solution.preserves_row_semantics
